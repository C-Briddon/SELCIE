...
class FieldSolver(object):
    ...
    def maximise_function(self, function, subdomain, check_boundary_only=False,
                          constraint=None):
        '''
        ...
        constraint : function, optional
            Takes position arguments (x, y, z), return True for points to be
            measure and Flase for points to be ignored. The default is None.

        Raises
        ------
        Exception
            If you vertex is found will raise exception. This can be caused
            by applying incorrect constraints.
